...
# 4e. Decisões da Forma de Pagamento e da Transferência (27/07/2026)
...
| V12 | Domínio, fatia 2 (B-D1): `cartao`, `cartao_emitido`, `fatura`, `parcela`, `regra_recorrencia`. Sai junto da tela T-06. Resolve I-07 (estados da fatura). **Era a V11** até 27/07/2026, quando a forma de pagamento tomou o número — reserva era plano, não fato, e deixar um buraco na sequência para honrar uma anotação seria pior | ✘ |
